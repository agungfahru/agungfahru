import Menu from '../components/menu';
    ...
    const Berita = () =>(
       <div>
          <Menu />
          <main>
          <h1>KENAPA TUMPANG PITU HARUS DI TOLAK?</h1>
          <p>Direktur Wahana Lingkungan Hidup Indonesia (Walhi) Jatim Rere Christianto menegaskan tambang emas tumpang pitu harus ditolak. Sebab aktivitas penambangan melanggar undang-undang.
...
Selain ada pelanggaran dari segi perundangan, lanjutnya, Walhi melihat terjadi kerusakan hutan. Catatan Walhi Jatim, tahun 2015 dan 2016 pernah terjadi banjir lumpur dari Gunung Tumpang Pitu ke Pantai Pulau Merah. .</p>
</main>
       </div>
    )
